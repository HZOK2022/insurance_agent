...
#### 步骤 3:扩展 QdrantStore(按 doc\_id 删除)
...
| `app/retrieval/qdrant_store.py`       | 修改(加 delete\_by\_doc\_id)                 |
...
| `app/api/services/container.py`       | 修改(加 get\_knowledge\_store/get\_ingester) |
